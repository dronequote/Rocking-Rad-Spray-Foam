...
export const services: Service[] = [
  {
    ...
    benefits: [
      'R-3.7 per inch of insulation value',
      'Expands 100x to seal every crack and gap',
      'Excellent sound dampening between rooms',
      'Lower cost per square foot than closed cell',
      'Ideal for interior applications and attics',
...
Not sure which is right for your project? That's what the free estimate is for. We'll walk your property, assess your needs, and recommend the best foam type for your specific situation.`,
  ...
  },
  {
    ...
    benefits: [
      'R-6.5 to R-7.0 per inch — highest available',
      'Built-in vapor barrier stops moisture dead',
      'Adds structural rigidity to walls and roofs',
      'Resists water, flooding, and condensation',
      'Ideal for metal buildings and crawl spaces',
      'Meets code in thinner applications',
    ],
...
Think of closed cell spray foam as a permanent upgrade to your property — not an expense. The insulation value never degrades. The structural improvement is permanent. The moisture barrier doesn't wear out. Twenty years from now, the closed cell foam in your building will perform exactly as it does the day it's installed. That's the difference between spray foam and every other insulation type on the market.`,
  ...
  },
  {
    ...
    benefits: [
      'Cut energy bills 30–50% by sealing the #1 heat loss zone',
      'Eliminate hot and cold spots throughout your home',
      'Stop ice dams and moisture damage in winter',
      'Reduce HVAC strain and extend equipment life',
      'Seal out dust, allergens, and outdoor pollutants',
      'One-day installation for most residential attics',
    ],
...
Don't forget the 30% federal tax credit — up to $1,200 back on your insulation project. That accelerates payback significantly.`,
  ...
  },
  {
    ...
    benefits: [
      'Eliminates condensation on metal surfaces',
      'Cuts heating and cooling costs 40–60%',
      'Bonds directly to metal — no framing needed',
      'Adds structural rigidity to walls and roof',
      'Protects equipment, livestock, and inventory',
      'Transforms unusable space into year-round workspace',
    ],
...
For buildings with no existing climate control, the energy savings are dramatic. We've seen clients go from spending $400–$600/month on propane heating to under $150 after insulating. The foam pays for itself, then keeps paying you back.`,
  ...
  },
  {
    ...
    benefits: [
      'Meet or exceed Oklahoma commercial energy codes',
      'Reduce heating and cooling costs 30–50%',
      'Improve employee comfort and productivity',
      'Protect inventory and equipment from temperature extremes',
      'Single-application insulation + air barrier + vapor barrier',
